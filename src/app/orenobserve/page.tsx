...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://cdn.content360.io/ea2381f4-12e0-4efd-b95b-6012c981eae0/uploads/04-2026/JkgbWmauRB7suRUl6bVem2msNPATeMS2h4iWgdcR.png", width: 1200, height: 630, alt: "OrenObserve" }],
  },
}
    ...
    <main style={{ fontFamily: "'Roboto', sans-serif", background: "linear-gradient(165deg, #081628 0%, #0B1D3A 30%, #0F2847 60%, #0D2240 100%)", color: "#F0F4FA" }}>
      ...
      <section style={{ background: "linear-gradient(180deg, #0B1D3A 0%, #0D2240 100%)", padding: "100px 24px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(34px,5vw,56px)", fontWeight: 900, color: "#F0F4FA", letterSpacing: "-0.03em", marginBottom: 16 }}>The Control Room For Your AI</h2>
          </div>
      ...
      <section style={{ padding: "100px 24px", background: "linear-gradient(165deg, #0B1D3A 0%, #0D2240 100%)", textAlign: "center" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(30px,4.5vw,52px)", fontWeight: 900, color: "#F0F4FA", letterSpacing: "-0.02em", marginBottom: 20 }}>Turn on the <span style={{ color: "#CC5500" }}>lights</span>.</h2>
