...
<style>
    ...
    :root{--primary:#CC5500;--primary-light:#E8762B;--primary-dark:#B34A00;--accent:#CC5500;--accent-dark:#B34A00;--bg-dark:#0B1D3A;--bg-card:rgba(255,255,255,0.03);--border:rgba(255,255,255,0.06);--text:#F0F4FA;--text-secondary:rgba(210,225,245,0.6);--text-muted:rgba(210,225,245,0.4)}
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .hero-visual{flex:0 0 auto;width:360px;height:340px;position:relative}
    ...
    .schematic-line{stroke:rgba(204,85,0,0.3);stroke-width:1.5;fill:none;stroke-dasharray:200;stroke-dashoffset:200;animation:drawLine 3s ease forwards}
    .schematic-line:nth-child(2){animation-delay:0.3s}
    .schematic-line:nth-child(3){animation-delay:0.6s}
    .schematic-line:nth-child(4){animation-delay:0.9s}
    .schematic-line:nth-child(5){animation-delay:1.2s}
    .schematic-line:nth-child(6){animation-delay:1.5s}
    .schematic-line:nth-child(7){animation-delay:1.8s}
    .schematic-line:nth-child(8){animation-delay:2.1s}
    .schematic-line:nth-child(9){animation-delay:2.4s}
    @keyframes drawLine{to{stroke-dashoffset:0}}
    .schematic-node{fill:#0B1D3A;stroke:#CC5500;stroke-width:2;opacity:0;animation:nodeAppear 0.5s ease forwards}
    .schematic-node:nth-child(10){animation-delay:0.5s}
    .schematic-node:nth-child(11){animation-delay:0.8s}
    .schematic-node:nth-child(12){animation-delay:1.1s}
    .schematic-node:nth-child(13){animation-delay:1.4s}
    .schematic-node:nth-child(14){animation-delay:1.7s}
    .schematic-node:nth-child(15){animation-delay:2.0s}
    .schematic-node:nth-child(16){animation-delay:2.3s}
    .schematic-node:nth-child(17){animation-delay:2.6s}
    @keyframes nodeAppear{to{opacity:1}}
    .schematic-glow{fill:none;stroke:#CC5500;stroke-width:3;opacity:0;filter:url(#glow);animation:pulseGlow 3s ease-in-out infinite}
    .schematic-glow:nth-child(18){animation-delay:0s}
    .schematic-glow:nth-child(19){animation-delay:0.4s}
    .schematic-glow:nth-child(20){animation-delay:0.8s}
    .schematic-glow:nth-child(21){animation-delay:1.2s}
    .schematic-glow:nth-child(22){animation-delay:1.6s}
    .schematic-glow:nth-child(23){animation-delay:2s}
    .schematic-glow:nth-child(24){animation-delay:2.4s}
    .schematic-glow:nth-child(25){animation-delay:2.8s}
    @keyframes pulseGlow{0%,100%{opacity:0;r:8}30%,70%{opacity:0.7;r:12}50%{opacity:1;r:14}}
    ...
    .flow-icon.amber{background:rgba(204,85,0,0.1);border:2px solid rgba(204,85,0,0.3)}.flow-icon.amber svg{stroke:#CC5500}
    .flow-icon.dark{background:rgba(255,255,255,0.03);border:2px solid rgba(255,255,255,0.08)}.flow-icon.dark svg{stroke:var(--text-secondary)}
    .flow-label{font-family:'Roboto',sans-serif!important;font-size:12px;font-weight:700;color:var(--text-muted);text-transform:uppercase;letter-spacing:1px}
    .flow-connector{flex:1;height:2px;background:rgba(204,85,0,0.15);position:relative;min-width:30px;max-width:100px}
    .flow-connector::after{content:'';position:absolute;top:-3px;width:8px;height:8px;background:#CC5500;border-radius:50%;animation:flowDot 2.5s ease-in-out infinite;box-shadow:0 0 12px rgba(204,85,0,0.5)}
    ...
    /* ===== STATS ===== */
    .stats-section{max-width:1200px;margin:0 auto;padding:80px 40px;display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:20px;border-top:1px solid rgba(204,85,0,0.2);border-bottom:1px solid rgba(204,85,0,0.2)}
    .stat-item{text-align:center;padding:28px 16px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:16px;transition:all .3s;backdrop-filter:blur(12px)}
    .stat-item:hover{border-color:rgba(204,85,0,0.35);background:rgba(204,85,0,0.06);transform:translateY(-2px)}
    .stat-value{font-family:'Playfair Display',serif!important;font-size:40px!important;font-weight:900!important;color:#CC5500!important;-webkit-text-fill-color:#CC5500!important;line-height:1;margin-bottom:8px;display:block}
    .stat-label{font-family:'Roboto',sans-serif!important;font-size:11px!important;font-weight:700;color:var(--text-muted);text-transform:uppercase;letter-spacing:1.5px;display:block}
    ...
    .capability-card{position:relative;background:rgba(255,255,255,0.03)!important;border:1px solid rgba(255,255,255,0.06)!important;border-radius:20px;padding:32px;transition:all .3s;backdrop-filter:blur(12px)}
    .capability-card:hover{transform:translateY(-4px);border-color:rgba(204,85,0,0.35)!important;background:rgba(204,85,0,0.04)!important;box-shadow:0 12px 32px rgba(204,85,0,0.1)}
    .capability-card .card-accent{position:absolute;top:-1px;left:-1px;right:-1px;height:4px;background:linear-gradient(90deg,#CC5500,#E8762B)!important;border-radius:20px 20px 0 0;opacity:0;transition:opacity .3s}
    .capability-card:hover .card-accent{opacity:1}
    .card-icon{width:56px;height:56px;border-radius:14px;background:rgba(204,85,0,0.08);border:1px solid rgba(204,85,0,0.2);display:flex;align-items:center;justify-content:center;margin-bottom:20px;transition:transform .3s}
    .capability-card:hover .card-icon{transform:scale(1.1)}
    .card-icon svg{width:26px;height:26px;stroke:#CC5500;fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}
    .capability-card h3{font-size:22px!important;font-weight:800!important;margin-bottom:12px!important;color:#F0F4FA!important}
    .capability-card p{font-family:'Roboto',sans-serif!important;font-size:15px!important;line-height:1.7;color:rgba(210,225,245,0.55)!important;margin-bottom:20px}
    .capability-card ul{list-style:none;padding:0}
    .capability-card ul li{font-family:'Roboto',sans-serif!important;font-size:14px!important;color:var(--text-muted);padding:8px 0 8px 24px;position:relative}
    .capability-card ul li::before{content:"→";position:absolute;left:0;color:#CC5500;font-weight:bold}
    ...
    .why-card:hover{background:rgba(204,85,0,0.04);border-color:rgba(204,85,0,0.15)}
    .why-icon{width:52px;height:52px;background:rgba(204,85,0,0.08);border:1px solid rgba(204,85,0,0.18);border-radius:14px;display:flex;align-items:center;justify-content:center;flex-shrink:0}
    .why-icon svg{width:24px;height:24px;stroke:#CC5500;fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}
    .why-card h3{font-size:20px!important;font-weight:800!important;margin-bottom:8px!important;color:#F0F4FA!important}
    .why-card p{font-family:'Roboto',sans-serif!important;font-size:14px!important;line-height:1.7;color:var(--text-muted)}
    ...
    .process-number{flex-shrink:0;width:80px;height:80px;border-radius:16px;background:rgba(204,85,0,0.08)!important;border:2px solid rgba(204,85,0,0.25)!important;display:flex;align-items:center;justify-content:center;font-size:32px!important;font-weight:900!important;color:#CC5500!important;-webkit-text-fill-color:#CC5500!important}
    .process-content h3{font-size:24px!important;font-weight:800!important;margin-bottom:12px!important;color:#F0F4FA!important}
    .process-content p{font-family:'Roboto',sans-serif!important;font-size:16px!important;line-height:1.7;color:rgba(210,225,245,0.55)!important}

    /* ===== TRUSTED ===== */
    .trusted-section{max-width:900px;margin:0 auto;padding:60px 40px;text-align:center}
    .trusted-label{font-family:'Roboto',sans-serif!important;font-size:11px;font-weight:700;color:var(--text-muted);text-transform:uppercase;letter-spacing:3px;margin-bottom:28px}
    ...
    .cta-title{font-size:clamp(36px,5vw,56px)!important;line-height:1.08;margin-bottom:24px!important;font-weight:900!important;letter-spacing:-0.03em;color:#F0F4FA!important}
    .cta-description{font-family:'Roboto',sans-serif!important;font-size:18px!important;line-height:1.7;color:rgba(210,225,245,0.55)!important;margin-bottom:40px;max-width:600px;margin-left:auto;margin-right:auto;font-weight:300}

    /* ===== RESPONSIVE ===== */
    @media(max-width:768px){
      .hero{padding:100px 20px 60px;min-height:70vh}
      .hero-inner{flex-direction:column;text-align:center}
      .hero-visual{width:280px;height:260px;margin:0 auto}
  ...
  <section class="hero">
    <div class="hero-inner">
      ...
      <div class="hero-visual">
        <svg class="schematic-svg" viewBox="0 0 360 340" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <filter id="glow"><feGaussianBlur stdDeviation="4" result="blur"/><feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
          </defs>
          <!-- Lines connecting nodes -->
          <line class="schematic-line" x1="60" y1="60" x2="180" y2="40"/>
          <line class="schematic-line" x1="180" y1="40" x2="300" y2="80"/>
          <line class="schematic-line" x1="60" y1="60" x2="120" y2="170"/>
          <line class="schematic-line" x1="180" y1="40" x2="180" y2="170"/>
          <line class="schematic-line" x1="300" y1="80" x2="260" y2="170"/>
          <line class="schematic-line" x1="120" y1="170" x2="180" y2="170"/>
          <line class="schematic-line" x1="180" y1="170" x2="260" y2="170"/>
          <line class="schematic-line" x1="120" y1="170" x2="180" y2="280"/>
          <line class="schematic-line" x1="260" y1="170" x2="180" y2="280"/>
          <!-- Nodes -->
          <circle class="schematic-node" cx="60" cy="60" r="10"/>
          <circle class="schematic-node" cx="180" cy="40" r="12"/>
          <circle class="schematic-node" cx="300" cy="80" r="10"/>
          <circle class="schematic-node" cx="120" cy="170" r="10"/>
          <circle class="schematic-node" cx="180" cy="170" r="14"/>
          <circle class="schematic-node" cx="260" cy="170" r="10"/>
          <circle class="schematic-node" cx="180" cy="280" r="12"/>
          <circle class="schematic-node" cx="40" cy="170" r="6"/>
          <!-- Glow pulses -->
          <circle class="schematic-glow" cx="60" cy="60" r="10"/>
          <circle class="schematic-glow" cx="180" cy="40" r="12"/>
          <circle class="schematic-glow" cx="300" cy="80" r="10"/>
          <circle class="schematic-glow" cx="120" cy="170" r="10"/>
          <circle class="schematic-glow" cx="180" cy="170" r="14"/>
          <circle class="schematic-glow" cx="260" cy="170" r="10"/>
          <circle class="schematic-glow" cx="180" cy="280" r="12"/>
          <circle class="schematic-glow" cx="40" cy="170" r="6"/>
        </svg>
      </div>
    </div>
  </section>
