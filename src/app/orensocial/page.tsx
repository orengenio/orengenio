    ...
    <section>
        ...
        <div class="platform-grid">
            <div class="platform-card">
                <img src="https://blog.orengen.io/wp-content/uploads/2026/02/15.png" alt="LinkedIn">
                <h3>LinkedIn</h3>
                <p>Professional content, thought leadership, B2B engagement</p>
            </div>
            <div class="platform-card">
                <img src="https://blog.orengen.io/wp-content/uploads/2026/02/14.png" alt="YouTube">
                <h3>YouTube</h3>
                <p>Video publishing, SEO optimization, community management</p>
            </div>
            <div class="platform-card">
                <img src="https://blog.orengen.io/wp-content/uploads/2026/02/17.png" alt="Facebook">
                <h3>Facebook</h3>
                <p>Page management, ad integration, audience insights</p>
            </div>
            <div class="platform-card">
                <img src="https://blog.orengen.io/wp-content/uploads/2026/02/16.png" alt="X">
                <h3>X (Twitter)</h3>
