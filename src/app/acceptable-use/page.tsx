...
const html = `
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { background: var(--background); color: var(--foreground); font-family: 'Canva Sans', sans-serif; line-height: 1.6; }
    .page-header { padding: 80px 20px 60px; text-align: center; background: var(--background); }
    .page-header h1 { font-family: 'League Spartan', sans-serif; font-size: clamp(32px, 4vw, 48px); font-weight: 800; line-height: 1.2; margin: 0 0 16px 0; color: var(--foreground); letter-spacing: 0.02em; }
    .page-header h1 .orange { color: var(--oren-orange); }
    .page-header p { font-family: 'Canva Sans', sans-serif; font-size: clamp(14px, 2vw, 16px); color: rgba(255, 255, 255, 0.7); margin: 0 0 8px 0; line-height: 1.6; max-width: 700px; margin-left: auto; margin-right: auto; }
    .page-header .meta { font-size: 14px; color: rgba(255, 255, 255, 0.5); }
    .content-wrapper { max-width: 900px; margin: 0 auto; padding: 0 20px 80px; }
    .aup-section { margin-bottom: 40px; }
    .aup-section h2 { font-family: 'League Spartan', sans-serif; font-size: 24px; font-weight: 700; color: var(--oren-orange); margin-bottom: 16px; margin-top: 40px; }
    .aup-section h3 { font-family: 'League Spartan', sans-serif; font-size: 18px; font-weight: 600; color: var(--foreground); margin-bottom: 12px; margin-top: 24px; }
    .aup-section p { font-family: 'Canva Sans', sans-serif; font-size: 15px; line-height: 1.8; color: rgba(255, 255, 255, 0.8); margin-bottom: 16px; }
    .aup-section ul, .aup-section ol { margin-left: 24px; margin-bottom: 16px; }
    .aup-section li { font-family: 'Canva Sans', sans-serif; font-size: 15px; line-height: 1.8; color: rgba(255, 255, 255, 0.8); margin-bottom: 8px; }
    .aup-section strong { color: var(--foreground); font-weight: 600; }
    .highlight-box { background: rgba(204, 85, 0, 0.1); border-left: 4px solid var(--oren-orange); padding: 20px; margin: 24px 0; border-radius: 4px; }
    .highlight-box p { margin-bottom: 0; }
    .warning-box { background: rgba(204, 85, 0, 0.2); border: 2px solid var(--oren-orange); padding: 20px; margin: 24px 0; border-radius: 8px; }
    .warning-box h3 { margin-top: 0; color: var(--oren-orange); }
    .info-box { background: rgba(0, 51, 102, 0.1); border: 1px solid rgba(0, 51, 102, 0.3); padding: 24px; margin: 24px 0; border-radius: 8px; }
    .info-box h3 { margin-top: 0; color: #003366; }
    .contact-info { background: rgba(0, 51, 102, 0.1); border: 1px solid rgba(0, 51, 102, 0.3); padding: 24px; margin: 40px 0; border-radius: 8px; }
    .contact-info h3 { margin-top: 0; color: #003366; }
    .contact-info p { margin-bottom: 8px; }
    a { color: var(--oren-orange); text-decoration: none; }
    a:hover { text-decoration: underline; }
    @media (max-width: 768px) { .page-header { padding: 60px 20px 40px; } .content-wrapper { padding: 0 20px 60px; } .aup-section h2 { font-size: 20px; } .aup-section h3 { font-size: 16px; } }
  </style>
...
export default function Page() {
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .page-header h1 { font-family: 'League Spartan', sans-serif; font-size: clamp(32px, 4vw, 48px); font-weight: 800; line-height: 1.2; margin: 0 0 16px 0; color: var(--foreground); letter-spacing: 0.02em; }
    .page-header h1 .orange { color: var(--oren-orange); }
    .page-header p { font-family: 'Canva Sans', sans-serif; font-size: clamp(14px, 2vw, 16px); color: var(--oren-sub); margin: 0 0 8px 0; line-height: 1.6; max-width: 700px; margin-left: auto; margin-right: auto; }
    .page-header .meta { font-size: 14px; color: var(--oren-muted); }
    .content-wrapper { max-width: 900px; margin: 0 auto; padding: 0 20px 80px; }
    .aup-section { margin-bottom: 40px; }
    .aup-section h2 { font-family: 'League Spartan', sans-serif; font-size: 24px; font-weight: 700; color: var(--oren-orange); margin-bottom: 16px; margin-top: 40px; }
    .aup-section h3 { font-family: 'League Spartan', sans-serif; font-size: 18px; font-weight: 600; color: var(--foreground); margin-bottom: 12px; margin-top: 24px; }
    .aup-section p { font-family: 'Canva Sans', sans-serif; font-size: 15px; line-height: 1.8; color: var(--oren-sub); margin-bottom: 16px; }
    .aup-section ul, .aup-section ol { margin-left: 24px; margin-bottom: 16px; }
    .aup-section li { font-family: 'Canva Sans', sans-serif; font-size: 15px; line-height: 1.8; color: var(--oren-sub); margin-bottom: 8px; }
    .aup-section strong { color: var(--foreground); font-weight: 600; }
    .highlight-box { background: rgba(204, 85, 0, 0.1); border-left: 4px solid var(--oren-orange); padding: 20px; margin: 24px 0; border-radius: 4px; }
    .highlight-box p { margin-bottom: 0; }
    .warning-box { background: rgba(204, 85, 0, 0.2); border: 2px solid var(--oren-orange); padding: 20px; margin: 24px 0; border-radius: 8px; }
    .warning-box h3 { margin-top: 0; color: var(--oren-orange); }
    .info-box { background: var(--oren-close); border: 1px solid var(--oren-line-subtle); padding: 24px; margin: 24px 0; border-radius: 8px; }
    .info-box h3 { margin-top: 0; color: var(--oren-orange); }
    .contact-info { background: var(--oren-close); border: 1px solid var(--oren-line-subtle); padding: 24px; margin: 40px 0; border-radius: 8px; }
    .contact-info h3 { margin-top: 0; color: var(--oren-orange); }
    .contact-info p { margin-bottom: 8px; }
    a { color: var(--oren-orange); text-decoration: none; }
    a:hover { text-decoration: underline; }
    @media (max-width: 768px) { .page-header { padding: 60px 20px 40px; } .content-wrapper { padding: 0 20px 60px; } .aup-section h2 { font-size: 20px; } .aup-section h3 { font-size: 16px; } }
