  ...
  return (
    <>
      <style jsx>{`
        ...
        .oren-center{display:flex;align-items:center;justify-content:center;gap:4px}
        .oren-link,.oren-trigger{border:none;background:transparent;color:rgba(240,244,250,.85);text-decoration:none;font-size:15px;font-weight:500;height:42px;padding:0 16px;border-radius:var(--oren-radius);display:inline-flex;align-items:center;gap:6px;white-space:nowrap;cursor:pointer;transition:color .2s,background .2s}
