...
const footerColumns: FooterColumn[] = [
  ...
  { title: 'Legal', links: [{ name: 'Acceptable Use', href: '/acceptable-use' }, { name: 'Privacy Policy', href: '/privacy-policy' }, { name: 'Cookie Policy', href: '/cookie-policy' }, { name: 'Copyright Notice', href: '/copyright-notice' }, { name: 'Refund Policy', href: '/refund-policy' }, { name: 'Security Overview', href: '/security-overview' }, { name: 'SMS & AI Call Opt-In', href: '/sms-consent' }] }
];
...
const bottomLinks = [
  ...
  { path: '/sms-consent', label: 'SMS & AI Call Opt-In' },
  { path: '/ai-communications-opt-in', label: 'AI Communications Policy' },
