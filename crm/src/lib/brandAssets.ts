/**
 * Official OrenGen brand assets — keep in sync with repo root `src/lib/brandAssets.ts`.
 *
 * Variant rules (set by brand):
 *   - FAVICON              → every favicon slot.
 *   - LOGO_BLUE  (TPBG)    → use on majority WHITE / light surfaces.
 *   - LOGO_WHITE (TPBG)    → use on majority DARK surfaces.
 */
...
/** Default logo (alias of the blue / light-bg variant). */
